...
\end{figure}
 ...
 Enfin, on obtient une valeur de $T = 1.91 \pm 0.02$ s. D'après la solution analytique (qui est donc approximée), on a $I_{approx} = 0.068$ kg.m$^2$
 \begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{../fig/T2.png}
  \caption{Période en fonction du moment d'inertie}
 \end{figure}
